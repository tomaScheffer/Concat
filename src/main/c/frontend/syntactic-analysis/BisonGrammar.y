...
/** Terminals. */
%token <token> STRING_TOKEN ATOMIC_TOKEN BUFFER_TOKEN
%token <token> INP_TOKEN RND_TOKEN REV_TOKEN TUP_TOKEN TLO_TOKEN RPL_TOKEN NUM_TOKEN LEN_TOKEN ENC_TOKEN DEC_TOKEN
%token <token> FOR_TOKEN END_TOKEN FUN_TOKEN OUT_TOKEN
%token <string> STRING_LITERAL_TOKEN IDENTIFIER_TOKEN
